package com.brkcnszgn.detail_layout;
...
public class DetailFabLayout extends RelativeLayout {
    ...
    public DetailFabLayout(Context context) {
        super(context);
    }

    public DetailFabLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        parseAttrs(attrs);
    }

    public DetailFabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        parseAttrs(attrs);
    }

    private void parseAttrs(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.DetailFabLayout);

        SHOW_ANIM_DURATION = a.getInt(R.styleable.DetailFabLayout_showDuration, SHOW_ANIM_DURATION);
        HIDE_ANIM_DURATION = a.getInt(R.styleable.DetailFabLayout_hideDuration, HIDE_ANIM_DURATION);
        VERTICAL_MARGIN = a.getDimensionPixelSize(R.styleable.DetailFabLayout_verticalMargin, VERTICAL_MARGIN);
        HORIZONTAL_MARGIN = a.getDimensionPixelSize(R.styleable.DetailFabLayout_horizontalMargin, HORIZONTAL_MARGIN);
        pivotX = a.getDimensionPixelSize(R.styleable.DetailFabLayout_fadeInPivotX, -1);
        pivotY = a.getDimensionPixelSize(R.styleable.DetailFabLayout_fadeInPivotY, -1);
        fraction = a.getFloat(R.styleable.DetailFabLayout_fadeInFraction, fraction);
        fabId = a.getResourceId(R.styleable.DetailFabLayout_fabId, -1);
        containerId = a.getResourceId(R.styleable.DetailFabLayout_containerId, -1);
        toolbarId = a.getResourceId(R.styleable.DetailFabLayout_fabToolbarId, -1);
        fabDrawableAnimationEnabled = a.getBoolean(R.styleable.DetailFabLayout_fabDrawableAnimationEnabled, true);
